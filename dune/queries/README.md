...
SQL behind the [Word Circles — Gnosis Stats](https://dune.com/bh2smith/word-circles-gnosis-stats)
dashboard. Each `.sql` file mirrors a saved Dune query; the live query is the
execution engine, these files are the version-controlled source of truth.
...
| `05_pvp_player_leaderboard.sql`     | [7647942](https://dune.com/queries/7647942) | Per-player PvP economics (net CRC, ROI)        |
